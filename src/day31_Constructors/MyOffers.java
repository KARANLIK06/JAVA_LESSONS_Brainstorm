...
public class MyOffers {
        ...
        public static void main(String[] args) {
            ...
            offersWithBenefits.removeIf(p -> !(p.hasBenefit && p.hasPTO));            //remove all the offers that does not have benefit and does not have PTO
            System.out.println(offersWithBenefits.size());

            for (Offer offersWithBenefit : offersWithBenefits) {
                System.out.println(offersWithBenefit.companyName);
            }
            System.out.println("----------------------------------------------------");
            ...
            offersWith100K.removeIf(p -> !(p.salary<100000));           //  remove all the offers that are offering less than 100K salary
            System.out.println(offersWith100K.size());

            for (Offer offer100K : offersWith100K) {
                System.out.println(offer100K.companyName);
            }
